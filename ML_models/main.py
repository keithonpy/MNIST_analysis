...
print('softmax test_error by taking label with mod 3=', run_softmax_on_MNIST_mod3(temp_parameter=1))
...
print('softmax test_error after PCA =', run_softmax_on_MNIST_PCA(temp_parameter=1))
...
print('softmax test_error after cubic features =', run_softmax_on_MNIST_cube(temp_parameter=1))